...
def _build_parser():
    ...
    parser.add_argument('-v', '--variables', help='Any variables to be interpolated (as JSON string)')
    parser.add_argument('-e', '--env-variables', help='Any environment variables to be interpolated (as JSON string)')
    return parser
...
if __name__ == '__main__':
    ...
    output_s = replace_variables(input_s, variables=args.variables, extra_env=args.env_variables)
